...
import ProductCategoryUpdateComponent from '@/entities/products/product-category/product-category-update.vue';
import ProductCategoryClass from '@/entities/products/product-category/product-category-update.component';
