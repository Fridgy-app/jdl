...
import ProductDetailComponent from '@/entities/products/product/product-details.vue';
import ProductClass from '@/entities/products/product/product-details.component';
