...
import RecipeIngredientDetailComponent from '@/entities/products/recipe-ingredient/recipe-ingredient-details.vue';
import RecipeIngredientClass from '@/entities/products/recipe-ingredient/recipe-ingredient-details.component';
  ...
  describe('RecipeIngredient Management Detail Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<RecipeIngredientClass>(RecipeIngredientDetailComponent, {
        ...
        localVue,
        router,
        provide: { recipeIngredientService: () => recipeIngredientServiceStub },
      });
      comp = wrapper.vm;
    });
