...
import RecipeComponent from '@/entities/products/recipe/recipe.vue';
import RecipeClass from '@/entities/products/recipe/recipe.component';
...
describe('Component Tests', () => {
  describe('Recipe Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      ...
      // THEN
      expect(recipeServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(recipeServiceStub.retrieve.callCount).toEqual(3);
