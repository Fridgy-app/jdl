...
import ProductCategoryDetailComponent from '@/entities/products/product-category/product-category-details.vue';
import ProductCategoryClass from '@/entities/products/product-category/product-category-details.component';
