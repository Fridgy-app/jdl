  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="gatewayApp.productsProductCategory.home.createOrEditLabel"
          data-cy="ProductCategoryCreateUpdateHeading"
          v-text="$t('gatewayApp.productsProductCategory.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('gatewayApp.productsProductCategory.name')" for="product-category-name"
              >Name</label
            >
            <input
              type="text"
            ...
            <div v-if="$v.productCategory.name.$anyDirty && $v.productCategory.name.$invalid">
              <small class="form-text text-danger" v-if="!$v.productCategory.name.required" v-text="$t('entity.validation.required')">
