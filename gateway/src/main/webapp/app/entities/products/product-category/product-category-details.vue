    ...
    <div class="col-8">
      <div v-if="productCategory">
        <h2 class="jh-entity-heading" data-cy="productCategoryDetailsHeading">
          <span v-text="$t('gatewayApp.productsProductCategory.detail.title')">ProductCategory</span> {{ productCategory.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="$t('gatewayApp.productsProductCategory.name')">Name</span>
          </dt>
          <dd>
