...
import { IProductCategory, ProductCategory } from '@/shared/model/products/product-category.model';
    ...
    if (this.productCategory.id) {
      this.productCategoryService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('productsApp.productsProductCategory.updated', { param: param.id });
      ...
      this.productCategoryService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('productsApp.productsProductCategory.created', { param: param.id });
